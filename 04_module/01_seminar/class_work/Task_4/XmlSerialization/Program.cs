...
namespace XmlSerialization
{
    internal class Program
    {
        ...
        private static void SerializeMultiple(string path, List<int> numbers)
        {
            ...
            {
                var formatter = new XmlSerializer(typeof(List<Multiple>));
        ...
        /// <param name="path"> Path to file </param>
        /// <param name="numbers"> List of numbers </param>
        private static void XmlSerialization(string path, List<int> numbers)
        {
            try
            {
        ...
        private static void DeserializeMultiple(string path)
        {
            using (var fs = new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
                ...
                var rows = (List<Multiple>)formatter.Deserialize(fs);
