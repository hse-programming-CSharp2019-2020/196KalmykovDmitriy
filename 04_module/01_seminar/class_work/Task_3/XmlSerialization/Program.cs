...
namespace XmlSerialization
{
    internal class Program
    {
        ...
        private static void SerializeEquations(string path, int amount)
        {
            ...
            {
                var formatter = new XmlSerializer(typeof(List<Quadratic>));
        ...
        /// <param name="path"> Path to file </param>
        /// <param name="amount"> Amount of equations </param>
        private static void XmlSerialization(string path, int amount)
        {
            try
            {
        ...
        /// <param name="path"> Path to file </param>
        /// <param name="qDel"> My delegate </param>
        private static void XmlDeserialization(string path, Qdelegate qDel)
        {
            try
            {
                Process(path, qDel);
