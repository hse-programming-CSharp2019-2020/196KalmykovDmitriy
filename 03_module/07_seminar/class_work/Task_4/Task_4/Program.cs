...
namespace Task_4
{
    internal class Program
    {
        ...
        /// <summary>
        /// Get array of circle centers.
        /// </summary>
        /// <param name="circles"> Array of circles </param>
        /// <returns> Array of circle centers </returns>
        private static PointS[] GetKeys(IReadOnlyList<CircleS> circles)
        {
            var keys = new PointS[Amount];
